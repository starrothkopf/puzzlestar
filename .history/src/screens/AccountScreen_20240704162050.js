		...
		<div className="account">
			...
			<div className="account-stats">
				...
				<p>Username:</p>
                    {editingUsername ? (
                        <>
                            <input className="account-input" type="text" defaultValue={currentUser.username} onChange={(e) => setNewUsername(e.target.value.toString)} />
				...
				<p>Email:</p>
                    {editingEmail ? (
                        <>
                            <input className="account-input" type="email" defaultValue={currentUser.email} onChange={(e) => setNewEmail(e.target.value.toString)} />
				...
				<p>Password:</p>
                    {editingPassword ? (
                        <>
                            <input className="account-input" type="password" defaultValue="*****" onChange={(e) => setNewPassword(e.target.value.toString)} />
