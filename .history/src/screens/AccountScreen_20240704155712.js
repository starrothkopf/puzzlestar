		...
		<div className="account">
			...
			<div className="account-stats">
				...
				<p>Email:</p>
                    {editingEmail ? (
                        <>
                            <input type="email" defaultValue={currentUser.email} onChange={(e) => console.log(e.target.value)} />
				...
				<p>Password:</p>
                    {editingPassword ? (
                        <>
                            <input type="password" defaultValue="*****" onChange={(e) => console.log(e.target.value)} />
