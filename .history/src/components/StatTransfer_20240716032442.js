...
export default function StatTransfer({closeModal}) {
    ...
    const [winPerc, setNumPlayed] = useState('');
    ...
    return (
        <div className="modal-overlay">
            ...
            <form className="transfer-form" id="stattransfer-form">
                ...
                <p>Win %:</p>
                <input className="transfer-form-input" type="number" placeholder="98%" value={numPlayed} onChange={(e) => setNumPlayed(e.target.value)} />
            </form>
