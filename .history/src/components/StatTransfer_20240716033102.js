        ...
        <div className="modal-overlay">
            ...
            <form className="transfer-form" id="stattransfer-form">
                <div className="stat-line">
                    <p>Games played:</p>
                    <input className="transfer-form-input" type="number" placeholder="178" value={numPlayed} onChange={(e) => setNumPlayed(e.target.value)} />
                </div>
                <div className="stat-line">
                    <p>Win %:</p>
                ...
                <div className="stat-line">
                    ...
                    <input className="transfer-form-input" type="number" placeholder="13" value={guess2} onChange={(e) => setGuess2(e.target.value)} />
                </div>
                <div className="stat-line">
                    <p>Wins in 3 guesses:</p>
                    <input className="transfer-form-input" type="number" placeholder="48" value={guess3} onChange={(e) => setGuess3(e.target.value)} />
                </div>
                <div className="stat-line">
                    <p>Wins in 4 guesses:</p>
                    <input className="transfer-form-input" type="number" placeholder="69" value={guess4} onChange={(e) => setGuess4(e.target.value)} />
                </div>
                <div className="stat-line">
                    <p>Wins in 5 guesses:</p>
                    <input className="transfer-form-input" type="number" placeholder="33" value={guess5} onChange={(e) => setGuess5(e.target.value)} />
                </div>
                <div className="stat-line">
                    <p>Wins in 6 guesses:</p>
                    <input className="transfer-form-input" type="number" placeholder="12" value={guess6} onChange={(e) => setGuess6(e.target.value)} />
                </div>
            </form>
