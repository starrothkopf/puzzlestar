...
export default function WordleStats({ id }) {
    ...
    return (
        <div className="stats">
            ...
            <div className="bars">
                <div className="bar" style={{ width: `${getBarWidth(currentUser["won_in_1"])}%` }}>2: {stats.won_in_2}</div>
                <div className="bar" style={{ width: `${getBarWidth(currentUser["won_in_1"])}%` }}>3: {stats.won_in_3}</div>
                <div className="bar" style={{ width: `${getBarWidth(currentUser["won_in_1"])}%` }}>4: {stats.won_in_4}</div>
