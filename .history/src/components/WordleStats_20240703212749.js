...
export default function WordleStats({ id }) {
    ...
    return (
        ...
        <span style={{ color: stats.won_in_1 === 0 ? '#000' : '#333' }}>1 </span>{stats.won_in_1}
    </div>
    <div style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>
        <span style={{ color: stats.won_in_2 === 0 ? '#000' : '#333' }}>2 </span>{stats.won_in_2}
    </div>
    <div style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>
        <span style={{ color: stats.won_in_3 === 0 ? '#000' : '#333' }}>3 </span>{stats.won_in_3}
    </div>
    <div style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>
        <span style={{ color: stats.won_in_4 === 0 ? '#000' : '#333' }}>4 </span>{stats.won_in_4}
    </div>
    <div style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>
        <span style={{ color: stats.won_in_5 === 0 ? '#000' : '#333' }}>5 </span>{stats.won_in_5}
    </div>
    <div style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>
        <span style={{ color: stats.won_in_6 === 0 ? '#000' : '#333' }}>6 </span>{stats.won_in_6}
    </div>
        </div>
    )
}