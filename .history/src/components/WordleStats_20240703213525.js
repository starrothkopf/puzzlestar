...
export default function WordleStats({ id }) {
    ...
    return (
        <div className="stats">
            ...
            <div style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>3: {stats.won_in_3}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>4: {stats.won_in_4}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>5: {stats.won_in_5}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>6: {stats.won_in_6}</div>
