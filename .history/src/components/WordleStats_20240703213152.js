...
export default function WordleStats({ id }) {
    ...
    return (
        ...
        <div style={{ width: `${getBarWidth(stats.won_in_1)}%` }}>
            <span className="bar-number">{stats.won_in_1}</span>
        </div>
        <div style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>
            <span className="bar-number">{stats.won_in_2}</span>
        </div>
        <div style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>
            <span className="bar-number">{stats.won_in_3}</span>
        </div>
        <div style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>
            <span className="bar-number">{stats.won_in_4}</span>
        </div>
        <div style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>
            <span className="bar-number">{stats.won_in_5}</span>
        </div>
        <div style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>
            <span className="bar-number">{stats.won_in_6}</span>
        </div>
    </div>
        </div>
    )
