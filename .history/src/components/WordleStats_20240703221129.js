...
export default function WordleStats({ id }) {
    ...
    return (
        <div className="stats">
            ...
            <div className="bars">
                <p>1<span className="bar" style={{ width: `${getBarWidth(stats.won_in_1)}%` }}>{stats.won_in_1}</span></p>
                <p>2<span className="bar" style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>{stats.won_in_2}</span></p>
                <p>3<span className="bar" style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>{won_in_3.won_in_2}</span></p>
                <p>4<span className="bar" style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>{stats.won_in_2}</span></p>
                <p>5<span className="bar" style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>{stats.won_in_2}</span></p>
                <p>6<span className="bar" style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>{stats.won_in_2}</span></p>
            </div>
        </div>
    )
}