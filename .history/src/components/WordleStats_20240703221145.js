    ...
    return (
        <div className="stats">
            ...
            <div className="bars">
                ...
                <p>5<span className="bar" style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>{stats.won_in_5}</span></p>
                <p>6<span className="bar" style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>{stats.won_in_6}</span></p>
            </div>
        </div>
    )
}