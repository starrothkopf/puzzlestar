    ...
    setTimeout(async () => { // delay stat updates for suspense
      try {
        ...
        if (isCorrect) {
          ...
          const currentGuesses = currentUser.wordle_guesses || {};
    
    // Create a new object with the updated guess count
    const updatedGuesses = {
      ...currentGuesses,
      [guessNumber]: parseInt(newCount)
    };
    
    // Patch the entire wordle_guesses object
    await patchData('wordle_guesses', updatedGuesses);
    ...
    <div>
        <div className="wordle-container">
            <div className="left-wordle-container">
              <Modal solution={solution} countdown={countdown} show={showModal} />
              <Grid
