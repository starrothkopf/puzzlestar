...
export default function WordleStats({ id }) {
    ...
    return (
        <div className="stats">
            ...
            <span>2</span>
            <span style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>{stats.won_in_2}</span>
            <span>3</span>
            <span style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>{stats.won_in_3}</span>
            <span>4</span>
            <span style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>{stats.won_in_4}</span>
            <span>5</span>
            <span style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>{stats.won_in_5}</span>
            <span>6</span>
            <span style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>{stats.won_in_6}</span>
        </div>
    )
}