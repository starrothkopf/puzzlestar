...
export default function WordleStats({ id }) {
    ...
    return (
        <div className="stats">
            ...
            <div style={{ width: `${getBarWidth(stats.won_in_1)}%` }}>Wins in 1 guess: {stats.won_in_1}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_2)}%` }}>Wins in 2 guesses: {stats.won_in_2}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>Wins in 3 guesses: {stats.won_in_3}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>Wins in 4 guesses: {stats.won_in_4}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>Wins in 5 guesses: {stats.won_in_5}</div>
            <div style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>Wins in 6 guesses: {stats.won_in_6}</div>
        </div>
    )
}