...
export default function WordleStats({ id }) {
    ...
    const getAverage = (value) => {
        return Math.getAverage(stats.won_in_1, stats.won_in_2, stats.won_in_3, stats.won_in_4, stats.won_in_5, stats.won_in_6);
    };
    ...
    return (
        <div className="stats">
            ...
            <p>Average guess: {stats.win_percentage}%</p>
