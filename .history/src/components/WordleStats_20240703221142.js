    ...
    return (
        <div className="stats">
            ...
            <div className="bars">
                ...
                <p>3<span className="bar" style={{ width: `${getBarWidth(stats.won_in_3)}%` }}>{stats.won_in_3}</span></p>
                <p>4<span className="bar" style={{ width: `${getBarWidth(stats.won_in_4)}%` }}>{stats.won_in_4}</span></p>
                <p>5<span className="bar" style={{ width: `${getBarWidth(stats.won_in_5)}%` }}>{stats.won_in_2}</span></p>
                <p>6<span className="bar" style={{ width: `${getBarWidth(stats.won_in_6)}%` }}>{stats.won_in_2}</span></p>
            </div>
        </div>
    )
}